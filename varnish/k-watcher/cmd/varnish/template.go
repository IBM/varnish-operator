...
func (vt *VCLTemplate) GenerateVCL(ips []string, targetPort int32) (io.Reader, error) {
	t, err := vt.t.Clone()
	if err != nil {
	...
	if err := t.ExecuteTemplate(&b, vt.filename, map[string]interface{}{"IPs": ips, "TargetPort": targetPort}); err != nil {
