...
var _ = Describe("Validation", func() {
	...
	Describe(".spec.varnish.restartPolicy with `Never`", func() {
		It("should be allowed", func() {
			vc := &icmv1alpha1.VarnishCluster{
				ObjectMeta: objMeta,
				Spec: icmv1alpha1.VarnishClusterSpec{
	...
	Describe(".spec.varnish.restartPolicy with `Always`", func() {
		It("should be allowed", func() {
			vc := &icmv1alpha1.VarnishCluster{
				ObjectMeta: objMeta,
				Spec: icmv1alpha1.VarnishClusterSpec{
	...
	Describe(".spec.varnish.restartPolicy with `OnFailure`", func() {
		It("should be allowed", func() {
			vc := &icmv1alpha1.VarnishCluster{
				ObjectMeta: objMeta,
				Spec: icmv1alpha1.VarnishClusterSpec{
	...
	Describe(".spec.varnish.restartPolicy field with not supported values", func() {
		It("should not be allowed", func() {
			vc := &icmv1alpha1.VarnishCluster{
				ObjectMeta: objMeta,
				Spec: icmv1alpha1.VarnishClusterSpec{
