...
func (in *ExtendedServiceSpec) DeepCopyInto(out *ExtendedServiceSpec) {
	*out = *in
	in.ServiceSpec.DeepCopyInto(&out.ServiceSpec)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtendedServiceSpec.
func (in *ExtendedServiceSpec) DeepCopy() *ExtendedServiceSpec {
	if in == nil {
		return nil
	}
	out := new(ExtendedServiceSpec)
	in.DeepCopyInto(out)
	return out
}
