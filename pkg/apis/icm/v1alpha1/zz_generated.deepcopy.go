...
func (in *VarnishDeployment) DeepCopyInto(out *VarnishDeployment) {
	*out = *in
	...
	if in.VarnishExporterResources != nil {
		in, out := &in.VarnishExporterResources, &out.VarnishExporterResources
		*out = new(v1.ResourceRequirements)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.VarnishRestartPolicy != nil {
		in, out := &in.VarnishRestartPolicy, &out.VarnishRestartPolicy
