...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HaproxySidecar) DeepCopyInto(out *HaproxySidecar) {
	*out = *in
	...
	if in.StatRefreshRate != nil {
		in, out := &in.StatRefreshRate, &out.StatRefreshRate
		*out = new(int32)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HaproxySidecar.
func (in *HaproxySidecar) DeepCopy() *HaproxySidecar {
	if in == nil {
		return nil
	}
	out := new(HaproxySidecar)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HaproxySidecarStatus) DeepCopyInto(out *HaproxySidecarStatus) {
	*out = *in
	in.ConfigMapStatus.DeepCopyInto(&out.ConfigMapStatus)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HaproxySidecarStatus.
func (in *HaproxySidecarStatus) DeepCopy() *HaproxySidecarStatus {
	if in == nil {
		return nil
	}
	out := new(HaproxySidecarStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VarnishClusterSpec) DeepCopyInto(out *VarnishClusterSpec) {
	*out = *in
	...
	if in.HaproxySidecar != nil {
		in, out := &in.HaproxySidecar, &out.HaproxySidecar
		*out = new(HaproxySidecar)
		(*in).DeepCopyInto(*out)
	}
}
